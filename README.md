...
You can download UniProt's human proteome here: <a href="http://www.uniprot.org/uniprot/?query=proteome:UP000005640" target="_blank"></a>. This is an example using 1% of the proteome:
```ShellSession
